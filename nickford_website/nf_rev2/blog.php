...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav navbar-right">
    <li><a href="<cms:link masterpage='index.php'/>#about">About</a></li>
    <li><a href="<cms:link masterpage='index.php'/>#portfolio">Portfolio</a></li>
    <li><a href="<cms:link masterpage='index.php'/>#skills">Skills</a></li>
    <li><a href="<cms:link masterpage='index.php'/>#contact">Contact</a></li>
    <li><a href="<cms:link masterpage='blog.php' />">Blog</a></li>
</ul>  
</div><!-- /.navbar-collapse -->
</div> <!-- /.container-fluid -->
</nav>
